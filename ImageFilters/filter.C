    ...
    for (i = 0; i < height; i++)
        for (j = 0; j < width; j++)
        {
            if ((image->GetPixel(j, i)).r > (image2->GetPixel(j, i)).r)
                Pixmap[i*width + j].r = (image->GetPixel(j, i)).r - (image2->GetPixel(j, i)).r;
            else
                Pixmap[i*width + j].r = 0;
            if ((image->GetPixel(j, i)).g > (image2->GetPixel(j, i)).g)
                Pixmap[i*width + j].g = (image->GetPixel(j, i)).g - (image2->GetPixel(j, i)).g;
            else
                Pixmap[i*width + j].g = 0;
            if ((image->GetPixel(j, i)).b > (image2->GetPixel(j, i)).b)
                Pixmap[i*width + j].b = (image->GetPixel(j, i)).b - (image2->GetPixel(j, i)).b;
            else
...
void Grayscale::Execute()
{
    ...
    for (i = 0; i < height; i++)
        for (j = 0; j < width; j++)   
        {
            Pixmap[i*width + j].r = ((image->GetPixel(j, i)).r / 5) + ((image->GetPixel(j, i)).g / 2) + ((image->GetPixel(j, i)).b / 4);
            Pixmap[i*width + j].g = ((image->GetPixel(j, i)).r / 5) + ((image->GetPixel(j, i)).g / 2) + ((image->GetPixel(j, i)).b / 4);
            Pixmap[i*width + j].b = ((image->GetPixel(j, i)).r / 5) + ((image->GetPixel(j, i)).g / 2) + ((image->GetPixel(j, i)).b / 4);
        }
...
void Blur::Execute()
{
    ...
    for (i = 0; i < height; i++)
        for (j = 0; j < width; j++)   
        {
            ...
            {
                Pixmap[i*width + j].r = (((image->GetPixel(j - 1, i - 1)).r / 8)
                                      ...
                                      + ((image->GetPixel(j + 1, i)).r / 8)
                                      + ((image->GetPixel(j + 1, i + 1)).r / 8));
                Pixmap[i*width + j].g = (((image->GetPixel(j - 1, i - 1)).g / 8)
                                      ...
                                      + ((image->GetPixel(j + 1, i)).g / 8)
                                      + ((image->GetPixel(j + 1, i + 1)).g / 8));
                Pixmap[i*width + j].b = (((image->GetPixel(j - 1, i - 1)).b / 8)
